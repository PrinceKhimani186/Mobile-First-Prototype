...
const MONETIZE = [
  {
    icon: <Megaphone />,
    title: "Advertising",
    desc: "Display ads, rewarded video, interstitials — every session generates revenue without charging users.",
  },
  {
    icon: <ShoppingCart />,
  ...
  },
  {
    icon: <Repeat />,
    title: "Subscriptions",
    desc: "Monthly or annual plans that unlock exclusive access, ad-free play, and premium content.",
  },
  {
    icon: <Radio />,
...
const BARRIERS = [
  {
    icon: <Settings />,
    title: "Too Technical",
    desc: "Most people believe you need years of coding experience. Modern app development has removed that barrier.",
  },
  {
    icon: <DollarSign />,
    title: "Too Expensive",
    desc: "Custom development can cost $100K–$500K+. Without a proven template system, most people can't afford entry.",
  },
  {
    icon: <Lock />,
    title: "Too Confusing",
    desc: "Developer accounts, App Store guidelines, monetization setup — labyrinthine without a guide who has navigated it hundreds of times.",
  },
  {
    icon: <Users />,
    title: "No Guidance",
    desc: "Without a team that knows the exact path from idea to live product, most people stall before they ever start.",
  },
];
...
const PROCESS = [
  {
    ...
    desc: "Browse 50+ proven game templates across categories. Select the one that aligns with your brand vision.",
  },
  {
    num: "02",
    title: "Customize Branding",
    desc: "Define your app name, visual identity, color palette, and brand elements with your dedicated coordinator.",
  },
  {
    num: "03",
    title: "Prepare Monetization",
    desc: "Ad networks, in-app purchases, and analytics configured and tested — revenue architecture built before launch.",
  },
  {
    num: "04",
    title: "Launch Your Digital Product",
    desc: "App Store and Google Play submission handled completely. You receive a live, revenue-ready digital asset.",
  },
];
...
const PACKAGES = [
  ...
  },
  {
    id: "accelerator",
    name: "App Ownership\nAccelerator",
    packageHeadline: "BRANDING · MONETIZATION · ASO",
    packageDesc:
...
const ENROLLMENT_STEPS = [
  {
    ...
    desc: "Review and sign the App Squad partnership agreement. All terms, deliverables, and timelines clearly defined.",
  },
  {
    icon: <CreditCard />,
    title: "Activate Your Package",
    desc: "Your investment is processed and your package activated immediately. Coordinator assigned within 24 hours.",
  },
  {
    icon: <Layers />,
    title: "Select Your Game Template",
    desc: "Browse 50+ proven templates and lock in your game category and genre with your coordinator's guidance.",
  },
  {
    icon: <Settings />,
    title: "Submit Customization Details",
    desc: "Complete your brand form — app name, colors, characters, and identity. This becomes your build blueprint.",
  },
  {
    icon: <LayoutDashboard />,
    title: "Receive Dashboard Access",
    desc: "Your owner's dashboard goes live. Track progress, review milestones, communicate with your team.",
  },
  {
    icon: <Rocket />,
    title: "Begin Development",
    desc: "Your dedicated build team activates and your app's development timeline officially starts.",
  },
  {
    icon: <TrendingUp />,
    title: "App Launch Preparation",
    desc: "Pre-launch checklist, app store optimization, and final QA review before your app goes live on both stores.",
  },
];
...
export default function Presentation() {
  const [paymentType, setPaymentType] = useState<"paid_in_full" | "monthly">(
    "paid_in_full",
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          <FadeUp delay={0.08}>
            ...
            >
              Most People <span style={{ color: GOLD }}>Spend Money</span> in
              Apps.
              <br />
              Very Few Ever <span style={{ color: GOLD }}>Own One.</span>
            </h1>
          </FadeUp>
          ...
          <FadeUp delay={0.15}>
            ...
            >
              The mobile app economy is one of the largest digital ecosystems in
              the world. Millions participate every day. Very few ever build an
              asset inside it.
            </p>
          </FadeUp>
      ...
      >
        ...
        <div
          style={{
            ...
            height: "100%",
            background:
              "radial-gradient(ellipse at 20% 50%, rgba(109,7,26,0.04) 0%, transparent 60%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        <FadeUp
          delay={0.06}
          style={{ textAlign: "center", marginBottom: 120, padding: "0 48px" }}
        >
          <h2
            style={{
              fontFamily: "'Space Grotesk'",
          ...
          >
            ...
            >
              Everyone in the app economy is either a
            </span>
            <span style={{ color: `rgba(109,7,26,0.65)` }}>Consumer</span>
            <span style={{ color: "rgba(255,255,255,0.14)", margin: "0 32px" }}>
              or an
            </span>
        ...
        >
          ...
          <SlideIn
            dir="left"
            delay={0.08}
            style={{ padding: "80px 72px 80px 80px" }}
          >
            <div
              style={{
                fontFamily: "'Space Grotesk'",
                ...
                textTransform: "uppercase",
                color: "rgba(109,7,26,0.65)",
                marginBottom: 28,
              }}
            >
              Most People Stay Consumers
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              >
                <Download
                  style={{ width: 36, height: 36, color: "rgba(109,7,26,0.6)" }}
                />
              </div>
              <div>
                <div
            ...
            >
              {[
                {
                  text: "Downloads Apps",
                  sub: "Fills someone else's ecosystem",
                },
                ...
                {
                  text: "Participates In Ecosystems",
                  sub: "With no ownership stake",
                },
              ].map((item) => (
                <li
                  key={item.text}
                ...
                >
                  <div
                    style={{
                      ...
                      height: 40,
                      borderRadius: 12,
                      background: "rgba(109,7,26,0.06)",
                      border: "1px solid rgba(109,7,26,0.12)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
          ...
          <SlideIn
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, rgba(0,212,255,0.03) 0%, transparent 60%)",
              position: "relative",
              overflow: "hidden",
            }}
          >
            ...
            >
              A Small Group Choose Ownership
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              {[
                {
                  text: "Owns Digital Assets",
                  sub: "A product that works without you",
                },
                { text: "Builds Brands", sub: "Identity, loyalty, and equity" },
                { text: "Creates Products", sub: "Users pay you for access" },
                {
                  text: "Owns Intellectual Property",
                  sub: "Something that compounds in value",
                },
                {
                  text: "Participates In Growth",
                  sub: "As the ecosystem expands, so do you",
                },
              ].map((item) => (
                <li
                  key={item.text}
        ...
        <FadeUp
          delay={0.28}
          style={{ padding: "100px 80px 0", textAlign: "center" }}
        >
          <p
            style={{
              fontFamily: "'Space Grotesk'",
      ...
      <section style={{ padding: "140px 48px 160px", position: "relative" }}>
        ...
        >
          <FadeUp style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            >
              See how customers moved from idea to ownership through the App
              Squad launch process.
            </p>
          </FadeUp>
          ...
          <ScaleIn delay={0.1}>
            <div
              style={{
                borderRadius: 24,
                overflow: "hidden",
                boxShadow: `0 0 0 1px rgba(0,212,255,0.12), 0 60px 120px -30px rgba(0,0,0,0.97), 0 0 100px -40px rgba(0,212,255,0.05)`,
              }}
            >
      ...
      <section
        style={{
          ...
          background:
            "linear-gradient(180deg, #050505 0%, #080808 25%, #050505 100%)",
          position: "relative",
        }}
      >
        <div
        ...
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          ...
          <FadeUp style={{ textAlign: "center", marginBottom: 110 }}>
            <Label>
              <BarChart3 style={{ width: 13, height: 13 }} /> 2025 Market
              Intelligence
            </Label>
            <h2
              style={{
            ...
            >
              The market already exists. The users already exist. The ecosystem
              already exists.
              <br />
              The only question is whether you're inside it as a consumer or an
              owner.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.06}>
            ...
            >
              {[
                {
                  val: "$1.1T",
                  label: "Global App Economy",
                  sub: "2025 — Data.ai / Sensor Tower",
                  color: GOLD,
                },
                {
                  val: "7.1B",
                  label: "Smartphone Users",
                  sub: "Worldwide — Statista 2025",
                  color: CYAN,
                },
                {
                  val: "40B+",
                  label: "Downloads / Quarter",
                  sub: "Q1 2025 Combined Stores",
                  color: "#7B61FF",
                },
                {
                  val: "$200B+",
                  label: "Consumer App Spend",
                  sub: "App Stores 2025 Combined",
                  color: "#34D399",
                },
              ].map((s) => (
                <div
                ...
                >
                  <div
                    style={{
                      ...
                      height: 80,
                      borderRadius: "50%",
                      background: `radial-gradient(ellipse, ${s.color}14 0%, transparent 70%)`,
                      filter: "blur(20px)",
                      pointerEvents: "none",
                    }}
                  />
          ...
          >
            <FadeIn delay={0.08}>
              ...
              >
                ...
                >
                  2025 mobile market — year-over-year
                </div>
            ...
            <FadeIn delay={0.12}>
              ...
              >
                ...
                >
                  Estimates from public industry data
                </div>
                <div
                  ...
                  {APP_BENCHMARKS.map((app, i) => (
                    <motion.div
                      ...
                      style={{
                        ...
                        borderRadius: 12,
                        padding: "18px 22px",
                        borderLeft: `3px solid rgba(0,212,255,${0.55 - i * 0.05})`,
                      }}
                    >
                      <div
                        style={{
          ...
          >
            {[
              {
                icon: "📱",
                title: "App Store Ecosystem",
                stat: "900M+",
                statSub: "Paid apps downloaded — iOS alone",
                facts: [
                  "Games account for 70%+ of total app revenue",
                  "Top 1% of games earn 90%+ of all revenue",
                  "Average smartphone user has 40+ apps installed",
                ],
              },
              {
                icon: "🌍",
                ...
                stat: "190+",
                statSub: "Countries served by major app stores",
                facts: [
                  "Asia Pacific leads total download volume",
                  "North America leads revenue per user",
                  "Emerging markets represent fastest growth",
                ],
              },
              {
                icon: "⚡",
                title: "2025 Market Velocity",
                stat: "40B+",
                statSub: "Downloads in a single quarter — 2025",
                facts: [
                  "Mobile gaming now outpaces console + PC combined",
                  "IAP revenue grew 38%+ over 3 years",
                  "Rewarded video is the fastest-growing ad format",
                ],
              },
            ].map((panel, i) => (
              <FadeUp key={panel.title} delay={i * 0.08}>
                ...
                >
                  <div style={{ fontSize: 44, marginBottom: 22 }}>
                    {panel.icon}
                  </div>
                  <div
                    style={{
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Top Game Categories by Download Volume
                  </div>
                  <div
                    style={{
                      fontFamily: "'Inter'",
                  ...
                  >
                    App Store &amp; Google Play combined — 2025–2026
                    intelligence
                  </div>
                </div>
                <div
                ...
                {[
                  {
                    rank: "#1",
                    cat: "Casual Games",
                    detail: "Puzzle, idle, match-3",
                    color: GOLD,
                  },
                  {
                    rank: "#2",
                    cat: "Arcade & Action",
                    detail: "Runners, shooters, platformers",
                    color: CYAN,
                  },
                  {
                    rank: "#3",
                    cat: "Strategy",
                    detail: "Tower defense, city builders",
                    color: "#7B61FF",
                  },
                  {
                    rank: "#4",
                    cat: "Word & Trivia",
                    detail: "Brain games, crosswords",
                    color: "#34D399",
                  },
                  {
                    rank: "#5",
                    cat: "Racing & Sports",
                    detail: "Simulation, endless racers",
                    color: "#F472B6",
                  },
                  {
                    rank: "#6",
                    cat: "RPG & Adventure",
                    detail: "Story-driven, character builds",
                    color: "#FB923C",
                  },
                ].map((row) => (
                  <div
      ...
      <section style={{ padding: "120px 48px" }}>
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          <FadeUp style={{ textAlign: "center", marginBottom: 80 }}>
            <Label>
              <DollarSign style={{ width: 13, height: 13 }} /> Revenue
              Architecture
            </Label>
            <h2
              style={{
            ...
            >
              Educational only. The best app businesses layer multiple streams
              from the same digital asset.
            </p>
          </FadeUp>
          <div
            style={{
      ...
      ══════════════════════════════════════════════════════════════ */}
      <section
        style={{ padding: "120px 48px", background: "rgba(12,15,22,0.7)" }}
      >
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          <FadeUp style={{ textAlign: "center", marginBottom: 80 }}>
            <Label>
              <Lock style={{ width: 13, height: 13 }} /> The Barriers
            </Label>
            <h2
              style={{
                fontFamily: "'Space Grotesk'",
          ...
          >
            {BARRIERS.map((b, i) => (
              <FadeUp key={b.title} delay={i * 0.08}>
                <div
                  style={{
                    background: "rgba(109,7,26,0.025)",
                    border: "1px solid rgba(109,7,26,0.1)",
                    borderRadius: 20,
                    padding: "48px 40px",
                    height: "100%",
                  }}
                >
                  <div
                    style={{
                      ...
                      borderRadius: 20,
                      background: "rgba(109,7,26,0.07)",
                      border: "1px solid rgba(109,7,26,0.13)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
          ...
          <FadeUp delay={0.24}>
            <div
              style={{
                ...
                position: "relative",
                overflow: "hidden",
                boxShadow: `0 0 100px -40px rgba(0,212,255,0.1)`,
              }}
            >
              <div
                style={{
              ...
              >
                Every barrier above is removed inside the App Squad system.
                Technical, financial, logistical, and directional — all handled.
              </p>
            </div>
          </FadeUp>
        </div>
      ...
      <section style={{ padding: "120px 48px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <FadeUp style={{ textAlign: "center", marginBottom: 80 }}>
            <Label>
              <Award style={{ width: 13, height: 13 }} /> The Process
            </Label>
            <h2
              style={{
                fontFamily: "'Space Grotesk'",
      ...
      >
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          <FadeUp style={{ textAlign: "center", marginBottom: 80 }}>
            <Label>
              <Layers style={{ width: 13, height: 13 }} /> Template Library
            </Label>
            <h2
              style={{
                fontFamily: "'Space Grotesk'",
            ...
            >
              Every template is tested in real app stores with real users.
              You're not starting from scratch — you're starting from proven.
            </p>
          </FadeUp>
          <div
            style={{
              ...
              <FadeUp key={tmpl.name} delay={i * 0.06}>
                <div
                  style={{
                    ...
                    overflow: "hidden",
                    transition:
                      "border-color 0.22s, background 0.22s, transform 0.22s",
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = `rgba(0,212,255,0.3)`;
                ...
                >
                        ...
                        background:
                          tmpl.tag === "Most Popular"
                            ...
                            : tmpl.tag === "New"
                              ? "rgba(52,211,153,0.1)"
                              : "rgba(0,212,255,0.09)",
                        border: `1px solid ${tmpl.tag === "Most Popular" ? `rgba(0,212,255,0.28)` : tmpl.tag === "New" ? "rgba(52,211,153,0.22)" : "rgba(0,212,255,0.2)"}`,
                        fontSize: 11,
                        fontWeight: 700,
                  ...
                  <div style={{ fontSize: 60, marginBottom: 22 }}>
                    {tmpl.icon}
                  </div>
                  <div
                    style={{
          ...
          <FadeUp delay={0.35} style={{ textAlign: "center", marginTop: 44 }}>
            ...
            >
              And 40+ more — puzzle, idle, arcade, simulation, trivia, and
              beyond.
            </p>
          </FadeUp>
        </div>
      ...
      >
        ...
        <div style={{ maxWidth: 1500, margin: "0 auto" }}>
          <FadeUp style={{ textAlign: "center", marginBottom: 36 }}>
            <Label>
              <Package style={{ width: 13, height: 13 }} /> The Decision
            </Label>
            <h2
              style={{
                fontFamily: "'Space Grotesk'",
          ...
          >
            ...
            >
              Five paths. One goal. The right entry point depends on where you
              are and how fast you want to move.
            </p>
          </FadeUp>
                ...
                <FadeUp key={pkg.name} delay={i * 0.1} style={{ gridColumn }}>
                  <div
                    style={{
                      background: pkg.isAccelerator
                        ...
                        : pkg.isEmpire
                          ? "linear-gradient(155deg, #130F28 0%, #0D0B1C 60%, #080614 100%)"
                          : "rgba(255,255,255,0.02)",
                      border: pkg.isAccelerator
                        ? `1px solid rgba(0,212,255,0.55)`
                        : pkg.isEmpire
                          ? "1px solid rgba(123,97,255,0.42)"
                  ...
                  >
                      ...
                      style={{
                        ...
                        background: pkg.isAccelerator
                          ...
                          : pkg.isEmpire
                            ...
                            : `rgba(0,212,255,0.07)`,
                        border: `1px solid ${pkg.isAccelerator ? "rgba(0,212,255,0.3)" : pkg.isEmpire ? "rgba(123,97,255,0.22)" : "rgba(0,212,255,0.18)"}`,
                        fontSize: 13,
                        fontWeight: 700,
                    ...
                    {(() => {
                      ...
                      const pricing =
                        packagePricing[paymentType][pkg.id as PkgId];
                      return (
                        <div
                          style={{
                            marginBottom: 28,
                        ...
                        >
                          <div
                            style={{
                              ...
                              border: `1px solid ${pkg.isAccelerator ? "rgba(0,212,255,0.2)" : pkg.isEmpire ? "rgba(123,97,255,0.16)" : "rgba(52,211,153,0.14)"}`,
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                            }}
                          ...
                          <span
                            style={{
                              fontFamily: "'Inter'",
                              fontSize: pkg.isAccelerator ? 20 : 19,
                              lineHeight: 1.55,
                              color: pkg.isAccelerator
                      ...
                      style={{
                        ...
                        ...(pkg.isAccelerator
                          ? {
                              ...
                              color: "#FFFFFF",
                              boxShadow:
                                "0 0 0 1px rgba(0,212,255,0.4), 0 8px 40px rgba(0,212,255,0.25), 0 4px 16px rgba(123,97,255,0.15)",
                            }
                          : pkg.isEmpire
                            ? {
                                background:
                                  "linear-gradient(135deg, #7B61FF 0%, #5B41DF 60%, #7B61FF 100%)",
                                border: "1px solid rgba(123,97,255,0.55)",
                                color: "#FFFFFF",
                                boxShadow:
                                  "0 0 0 1px rgba(123,97,255,0.2), inset 0 1px 0 rgba(255,255,255,0.08), 0 8px 32px rgba(123,97,255,0.3)",
                              }
                            : {
                                background: "#050505",
                                ...
                                color: "#00D4FF",
                                boxShadow:
                                  "0 0 0 1px rgba(0,212,255,0.08), inset 0 1px 0 rgba(0,212,255,0.06), 0 4px 20px rgba(0,0,0,0.4)",
                                transition:
                      ...
                      onMouseEnter={(e) => {
                        ...
                        if (pkg.isAccelerator) {
                          e.currentTarget.style.boxShadow =
                            "0 0 0 1px rgba(0,212,255,0.6), 0 16px 60px rgba(0,212,255,0.35), 0 8px 30px rgba(123,97,255,0.25)";
                          e.currentTarget.style.filter = "brightness(1.08)";
                        } else if (pkg.isEmpire) {
                          e.currentTarget.style.boxShadow =
                            "0 0 0 1px rgba(123,97,255,0.5), 0 12px 50px rgba(123,97,255,0.4), 0 4px 20px rgba(0,0,0,0.5)";
                          e.currentTarget.style.filter = "brightness(1.12)";
                        } else {
                          e.currentTarget.style.background = "#00D4FF";
                          e.currentTarget.style.color = "#050505";
                          e.currentTarget.style.boxShadow =
                            "0 0 0 1px rgba(0,212,255,0.6), 0 8px 40px rgba(0,212,255,0.3), 0 4px 16px rgba(0,0,0,0.4)";
                        }
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.transform =
          ...
          <FadeUp delay={0.3} style={{ textAlign: "center", marginTop: 60 }}>
            ...
            >
              All packages include the full App Squad guided launch process. The
              right path depends on your goals, timeline, and level of
              involvement.
            </p>
          </FadeUp>
        </div>
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeUp style={{ textAlign: "center", marginBottom: 80 }}>
            <Label>
              <Rocket style={{ width: 13, height: 13 }} /> What Happens Next
            </Label>
            <h2
              style={{
                fontFamily: "'Space Grotesk'",
            ...
            >
              Once you select your package, here is the exact sequence of
              events. No guesswork — just a clear, guided path.
            </p>
          </FadeUp>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      width: "100%",
                      background: "rgba(255,255,255,0.02)",
                      border: `1px solid rgba(0,212,255,${0.12 - i * 0.01})`,
                      borderRadius: 18,
                      padding: "32px 40px",
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: 700,
                        letterSpacing: "-0.04em",
                        color: `rgba(0,212,255,${0.15 + (6 - i) * 0.04})`,
                        lineHeight: 1,
                        minWidth: 52,
                        flexShrink: 0,
                      }}
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          borderTop: `8px solid rgba(0,212,255,0.3)`,
                        }}
                      />
                    </div>
                  )}
      ...
      <section
        id="enroll"
        style={{ padding: "160px 48px 180px", position: "relative" }}
      >
        <div
          style={{
            position: "absolute",
        ...
        >
          <FadeUp>
            <Label>
              <Star style={{ width: 13, height: 13 }} /> Begin Your Journey
            </Label>
          </FadeUp>
          ...
          <FadeUp delay={0.13}>
            ...
            >
              Once you select your package, you will complete your agreement,
              activate your package, select your game template, submit your
              customization details, and receive dashboard access — all within
              your first week.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.25}>
            <button
              type="button"
              onClick={() =>
                openEnrollmentUrl(resolveEnrollmentUrl("/enrollment"))
              }
          ...
          <FadeUp delay={0.3} style={{ marginTop: 48 }}>
            ...
            >
              {[
                ...
                >
                  <CheckCircle2
                    style={{ width: 15, height: 15, color: GOLD }}
                  />
                  <span
                    style={{
                      fontFamily: "'Inter'",
          ...
          <FadeUp delay={0.35} style={{ marginTop: 80 }}>
            ...
            >
              ...
              >
                App Squad provides custom mobile game app development,
                monetization preparation, and app store publishing assistance.
                App Squad does not guarantee earnings, downloads, rankings, app
                approvals, ad revenue, in-app purchase revenue, profits, or
                return on investment. Results vary and depend on marketing, user
                engagement, platform rules, audience demand, app quality,
                consistency, and third-party approval processes.
              </p>
            </div>
          </FadeUp>
        </div>
