...
const PACKAGES = [
  {
    ...
    packageDesc: "For first-time app owners seeking one branded mobile game with guided setup.",
    tag: "ESSENTIALS",
    tagColor: CYAN,
    isAccelerator: false,
    isEmpire: false,
  ...
  },
  {
    ...
    packageDesc: "Enhanced branding, monetization prep, App Store Optimization, and priority support.",
    tag: "MOST POPULAR",
    tagColor: CYAN,
    isAccelerator: true,
    isEmpire: false,
  ...
  },
  {
    ...
    packageDesc: "Premium done-for-you experience with VIP support and strategic guidance.",
    tag: "PREMIUM",
    tagColor: PURPLE,
    isAccelerator: false,
    isEmpire: true,
...
const packagePricing = {
  ...
  monthly: {
    essentials:  { priceText: "$497 today",   subtext: "then $197/month for 12 months" },
    accelerator: { priceText: "$997 today",   subtext: "then $397/month for 12 months" },
    empire:      { priceText: "$4,997 today", subtext: "then $497/month for 12 months" },
  },
} as const;
